          ...
          {categories.map((cat) => (
            <button
              ...
              className={`text-[10px] tracking-[0.25em] transition-all pb-1 border-b ${
                activeCategory === cat ? 'border-black dark:border-white opacity-100' : 'border-transparent opacity-75 hover:opacity-100'
              }`}
            >
